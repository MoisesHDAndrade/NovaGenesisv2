<template>
    <div>
        <div class="modal fade" id="timesheetAddModal" tabindex="-1" aria-labelledby="timesheetAddModalLabel" aria-hidden="true" style="z-index:99999">
            <div class="modal-dialog modal-dialog-centered  modal-fullscreen-lg-down">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-light" id="timesheetAddModalLabel">Daywork form</h5>
                                ...
                                <ul class="list-group list-group-flush px-0">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex justify-content-around">
                                            ...
                                            <div class="col-6 text-end">
                                                <span class="">{{$root.currentTask.mjs_number}}</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="d-flex justify-content-around">
                                            ...
                                            <div class="col-6 text-end">
                                                <span class="">Te Aroha Apartments</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
...
export default {
    ...
    methods:{
        async addTimesheet(){
            this.loading = true
            const response = await axios.post(`${BASE_URL}/api/v1/timesheet/timesheet-add/`,{data:this.timesheetForm, mjs:this.$root.currentTask}, {headers:{'Authorization':`Bearer ${store.state.accessToken}`}})
